<ol class="breadcrumb">
  <li class="breadcrumb-item">Piket</li>
        ...
        <?php 
          ...
          if ($cek > 0) {
            while ($data = mysqli_fetch_array($query)) {
              ?>
              <a href="index.php?p=daftar_piket&nama_kelas=<?php echo $data['nama_kelas'] ?>" class="badge badge-success"><?php echo $data['nama_kelas'] ?></a>
              <?php
            }
          }else{
            ?>
        ...
        <?php 
          ...
          if ($cek2 > 0) {
            while ($data2 = mysqli_fetch_array($query2)) {
              ?>
              <a href="index.php?p=daftar_piket&nama_kelas=<?php echo $data2['nama_kelas'] ?>" class="badge badge-success"><?php echo $data2['nama_kelas'] ?></a>
              <?php
            }
          }else{
            ?>
        ...
        <?php 
          ...
          if ($cek3 > 0) {
            while ($data3 = mysqli_fetch_array($query3)) {
              ?>
              <a href="index.php?p=daftar_piket&nama_kelas=<?php echo $data3['nama_kelas'] ?>" class="badge badge-success"><?php echo $data3['nama_kelas'] ?></a>
              <?php
            }
          }else{
            ?>
